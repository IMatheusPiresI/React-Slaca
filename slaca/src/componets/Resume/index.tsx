...
export function Resume(){
    ...
    return(
        <Container> 
            <div>
                <header>
                    <TitleSession>Resumo</TitleSession>
                </header>
                <p className="text-resume">
                    ...
                    {viewMore ? 
                        <>
                            ...
                            <span>
                                Fusce vitae luctus dui. Donec id euismod mauris, in volutpat urna. Proin dapibus consequat feugiat. Proin dictum justo arcu, quis vestibulum augue lacinia quis. Sed dignissim dui nulla, ut faucibus mauris sodales id. Aliquam erat volutpat. Maecenas dolor enim, tincidunt id elit non, suscipit interdum turpis. Etiam finibus urna libero, eget interdum eros volutpat ullamcorper. Pellentesque et pretium lorem. Aenean interdum quis diam ac porttitor. Cras nec ipsum pulvinar, pharetra libero non, ornare enim. Etiam in laoreet odio. <strong onClick={() => setViewMore(false)}>ver menos</strong>
                            </span>
                        </>
                        : <strong onClick={() => setViewMore(true)}>...ver mais</strong>
                    }
                </p>
            </div>
